...
def write_data_postgres(dataframe: pd.DataFrame, db_config: dict) -> bool:
    """
    ...
    try:
        ...
        database_url = (
            f"{db_config['dbms_engine']}+psycopg2://"
            f"{db_config['dbms_username']}:{db_config['dbms_password']}@"
        ...
        # Connect to the engine and dump the DataFrame to the database table
        with engine.connect():
...
def main() -> None:
    db_config = {
        ...
        "dbms_ip": "localhost",
        "dbms_port": "15432",  
        "dbms_database": "nyc_datawarehouse",
        "dbms_table": "nyc_raw"
    }
